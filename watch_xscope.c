...
int main( int argc, char** argv){
  ...
  struct xwb_scope * scope1 =  xwb_scope_create_direct(&xdma->bus, OFFSET_AMC_XWB_SCOPE1);
  struct xwb_scope * scope2 =  xwb_scope_create_direct(&xdma->bus, OFFSET_AMC_XWB_SCOPE2);
